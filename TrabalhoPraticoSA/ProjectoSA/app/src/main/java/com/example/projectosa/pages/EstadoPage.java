...
public final class EstadoPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Observer<Integer> textViewEstadoObserver = new EstadoObserverTextView(textViewEstado, this);
    ...
    private void handleSwitch(){
        ...
        if(getActivity() == null) {
            throw new RuntimeException("EstadoPage: handleSwitch: getActivity is null");
        }
